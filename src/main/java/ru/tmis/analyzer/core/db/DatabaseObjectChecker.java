...
public class DatabaseObjectChecker {
    ...
    public static class NotNullConstraintInfo {
        ...
        public String getStatus() {
            if (isNotNullInOracle && !isNotNullInPostgres) return "ОШИБКА: В Oracle NOT NULL, в PostgreSQL NULL разрешен";
            if (!isNotNullInOracle && isNotNullInPostgres) return "ПРЕДУПРЕЖДЕНИЕ: В Oracle NULL разрешен, в PostgreSQL NOT NULL";
            return "OK";
        }
