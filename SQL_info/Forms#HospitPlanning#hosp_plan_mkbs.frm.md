# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/HospitPlanning/hosp_plan_mkbs.frm
...
**Анализируемая форма:** Forms/HospitPlanning/hosp_plan_mkbs.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_mkbs.frm
...
**Дата генерации:** Tue May 19 13:12:33 GMT+07:00 2026
...
**Имя компонента:** DS_HPK_MKBS
**Источник:** Forms/HospitPlanning/hosp_plan_mkbs.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_mkbs.frm

**SQL код:**

```xml
<component cmptype="DataSet" name="DS_HPK_MKBS" mode="Range">
	<![CDATA[
		select t.ID,
		       t.MKB,
		       t.MKB_HANDLE,
