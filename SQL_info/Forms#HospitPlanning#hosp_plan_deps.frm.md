# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/HospitPlanning/hosp_plan_deps.frm
...
**Анализируемая форма:** Forms/HospitPlanning/hosp_plan_deps.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_deps.frm
...
**Дата генерации:** Tue May 19 13:12:22 GMT+07:00 2026
...
**Имя компонента:** DS_HOSP_PLAN_DEPS
**Источник:** Forms/HospitPlanning/hosp_plan_deps.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_deps.frm

**SQL код:**

```xml
<component cmptype="DataSet" name="DS_HOSP_PLAN_DEPS" mode="Range">
	<![CDATA[
		select t.ID,
		       t.DEP_NAME,
		       t.DEP,
		 ...
		 where t.HP_KIND_ID = :HPK
	]]>
	<component cmptype="Variable" name="HPK" src="HPK_ID" srctype="var" get="v1" />
...
**Используемые таблицы/вьюхи:** D_V_HOSP_PLAN_DEPS
...
**Тип компонента:** M2 DataSet
**Имя компонента:** DS_HOSP_PLAN_DEP_BEDS
**Источник:** Forms/HospitPlanning/hosp_plan_deps.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_deps.frm
...
```xml
<component cmptype="DataSet" name="DS_HOSP_PLAN_DEP_BEDS" activateoncreate="false" mode="Range">
	<![CDATA[
		select t.ID,
		       t.BED_TYPE,
		       t.BED_TYPE_NAME
		  from d_v_hosp_plan_dep_beds t 
		 where t.PID = :ID
	]]>
	<component cmptype="Variable" name="ID" src="HOSP_PLAN_DEPS" srctype="ctrl" get="v1" />
	<component cmptype="Variable" type="count" srctype="var" src="r1c" default="10" />
	<component cmptype="Variable" type="start" srctype="var" src="r1s" default="1" />
</component>
```

**Используемые таблицы/вьюхи:** D_V_HOSP_PLAN_DEP_BEDS
