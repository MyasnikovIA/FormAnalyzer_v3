# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/Schedules/schedules_copy.frm
...
**Анализируемая форма:** Forms/Schedules/schedules_copy.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\Schedules\schedules_copy.frm
...
**Источник:** Forms/Schedules/schedules_copy.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\Schedules\schedules_copy.frm

**SQL код:**

```xml
<component cmptype="DataSet" name="DS_DAYS">
  select day_num,
         case day_num
    ...
    from (select level day_num from dual connect by level &lt;= 7)
    where day_num != :CURRENT_DAY
  <component cmptype="Variable" name="CURRENT_DAY" src="CURRENT_DAY" srctype="var" get="v0" />
</component>
```
