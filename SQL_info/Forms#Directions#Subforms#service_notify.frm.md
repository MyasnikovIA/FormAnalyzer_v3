# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/Directions/Subforms/service_notify.frm
...
**Анализируемая форма:** Forms/Directions/Subforms/service_notify.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\Directions\Subforms\service_notify.frm
