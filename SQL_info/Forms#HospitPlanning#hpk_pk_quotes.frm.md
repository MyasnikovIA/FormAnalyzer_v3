# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/HospitPlanning/hpk_pk_quotes.frm
...
**Анализируемая форма:** Forms/HospitPlanning/hpk_pk_quotes.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hpk_pk_quotes.frm
...
**Дата генерации:** Tue May 19 13:13:24 GMT+07:00 2026
...
**Имя компонента:** DS_HPK_PK_QUOTES
**Источник:** Forms/HospitPlanning/hpk_pk_quotes.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hpk_pk_quotes.frm

**SQL код:**

```xml
<component cmptype="DataSet" name="DS_HPK_PK_QUOTES" mode="Range">
	<![CDATA[
		select t.ID,
		       t.QUOTE,
		       t.DATE_BEGIN,
	...
	<component cmptype="Variable" name="HPK_PK" src="HPK_PK_ID" srctype="var" get="v1" />
