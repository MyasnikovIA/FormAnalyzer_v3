# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/HospitPlanning/hosp_plan_pks.frm
...
**Анализируемая форма:** Forms/HospitPlanning/hosp_plan_pks.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_pks.frm
...
**Дата генерации:** Tue May 19 13:12:28 GMT+07:00 2026
...
**Имя компонента:** DS_HPK_PAYMENT_KINDS
**Источник:** Forms/HospitPlanning/hosp_plan_pks.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hosp_plan_pks.frm

**SQL код:**

```xml
<component cmptype="DataSet" name="DS_HPK_PAYMENT_KINDS" mode="Range">
	<![CDATA[
		select t.ID,
		       t.HAS_QUOTES QUOTES,
		       t.PAYMENT_KIND,
                       t.PAYMENT_KIND_ID
		  from d_v_hpk_payment_kinds t
		 where t.LPU   = :LPU
		   and t.PID   = :HPK 
	]]>
...
**Используемые таблицы/вьюхи:** D_V_HPK_PAYMENT_KINDS
