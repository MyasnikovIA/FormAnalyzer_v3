# ЗАПРОС К LLM: АНАЛИЗ ФОРМЫ Forms/HospitPlanning/hpk_pk_quotes_edit.frm
...
**Анализируемая форма:** Forms/HospitPlanning/hpk_pk_quotes_edit.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hpk_pk_quotes_edit.frm
...
**Дата генерации:** Tue May 19 13:13:26 GMT+07:00 2026
...
**Источник:** Forms/HospitPlanning/hpk_pk_quotes_edit.frm
**Базовая форма:** C:\AppServ\www\5_mis_MEDDEV-151210\Forms\HospitPlanning\hpk_pk_quotes_edit.frm
	...
	begin
		select t.QUOTE,
		  ...
		  into :QUOTE,
		       ...
		       :QUOTA_GROUP,
		       :PERIOD
		  from d_v_hpk_pk_quotes t
		 where t.Id = :ID;
	end;
	<component cmptype="ActionVar" name="ID" src="ID" srctype="var" get="v1" />
	<component cmptype="ActionVar" name="QUOTE" src="QUOTE" srctype="ctrl" put="v1" len="8" />
	<component cmptype="ActionVar" name="DATE_BEGIN" src="DATE_BEGIN" srctype="ctrl" put="v2" len="25" />
	<component cmptype="ActionVar" name="DATE_END" src="DATE_END" srctype="ctrl" put="v3" len="25" />
	<component cmptype="ActionVar" name="QUOTA_GROUP_ID" src="QUOTA_GROUP" srctype="ctrl" put="v4" len="17" />
	<component cmptype="ActionVar" name="QUOTA_GROUP" src="QUOTA_GROUP" srctype="ctrlcaption" put="v5" len="20" />
	<component cmptype="ActionVar" name="PERIOD" src="PERIOD" srctype="ctrl" put="v6" len="3" />
</component>
```

**Используемые таблицы/вьюхи:** D_V_HPK_PK_QUOTES
